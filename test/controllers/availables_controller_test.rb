...
class AvailablesControllerTest < ActionController::TestCase
  ...
  test "should create available" do
    assert_difference('Available.count') do
      post :create, available: { active?: @available.active?, assignment_id: @available.assignment_id, begin: @available.begin, end: @available.end, proirity: @available.proirity, student_id: @available.student_id }
    end
  ...
  test "should update available" do
    patch :update, id: @available, available: { active?: @available.active?, assignment_id: @available.assignment_id, begin: @available.begin, end: @available.end, proirity: @available.proirity, student_id: @available.student_id }
    assert_redirected_to available_path(assigns(:available))
  end
